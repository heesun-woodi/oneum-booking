-- Fix TIME casting bug in create_booking_with_prepaid RPC function
-- Issue: column "start_time" is of type time without time zone but expression is of type text
-- Solution: Add explicit ::TIME casting for p_start_time and p_end_time parameters
...
BEGIN
  ...
  INSERT INTO bookings (
    ...
    p_user_id, 
    p_booking_date, 
    p_start_time::TIME,  -- ⭐ TIME 캐스팅 추가
    p_end_time::TIME,    -- ⭐ TIME 캐스팅 추가
    p_space,
    p_member_type, 
    p_household, 
    p_name, 
