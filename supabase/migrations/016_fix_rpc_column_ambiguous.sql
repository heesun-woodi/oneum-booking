-- Fix: column reference "status" is ambiguous
-- RETURN TABLE 컬럼명을 booking_status, booking_payment_status로 변경하여 충돌 해결
...
BEGIN
  ...
  INSERT INTO bookings (
    ...
    p_user_id, p_booking_date, p_start_time, p_end_time, p_space,
    p_member_type, p_household, p_name, p_phone, v_amount,
    v_status, v_payment_status, v_prepaid_hours_used, v_regular_hours,
    CASE 
